...
test("Demo Trade page includes trade ticket, management, CSV export, and reset modal", () => {
  ...
  assert.match(pageSource, /resolveSubmittedTakeProfitPrice\(takeProfit, side, referencePrice\)/);
  ...
  assert.match(pageSource, /priceInputMode: "price" as DemoTakeProfitInputMode/);
